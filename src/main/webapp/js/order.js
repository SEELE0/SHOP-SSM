$(function () {
    ...
    function orderlist(arry) {
        for (var i in arry) {
            ...
            var l2 = "<shiro:hasPermission name='delete'>&nbsp;&nbsp;&nbsp;&nbsp;<a class='oper_btn order_del' rel='" + arry[i]["id"] + "' href='javascript:;'>删除</a></shiro:hasPermission>";
            str+= l2
                    ...
                    $.ajax({
                        ...
                        success: function (m) {
                            if (m.state == 1) {
                                ...
                                setTimeout("location.href='user_center_order.jsp'", 1000);
                            } else {
