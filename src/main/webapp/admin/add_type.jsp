...
<head>
    ...
    <body>
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">添加商品的类别</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td width="40%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/Shop-SSM/addType.do" method="post">
                                                <table width="60%" class="cont">
                                                    <tr>
                                                        <td width="3%">&nbsp;&nbsp;</td>
                                                        <td>类别名称：</td>
                                                        <td ><input class="text" type="text" id="types" name="type_name" value="" /></td>
                                                    </tr>
                                                        <tr>
                                                        <td>&nbsp;</td>
                                                        <td colspan="3"><input class="btn" type="submit" onclick="return adds()"  value="提交" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </form>
        ...
        <script>
        function adds() {
			var type = $('#types').val().trim().length;
			if(type==0){
				alert("请输入类别");
				return false;
			}else if(type>8){
