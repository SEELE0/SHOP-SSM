...
<head>
    ...
    <body>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;font-size: 14px">未发货订单</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
         ...
         <script type="text/javascript" src="../js/jquery-3.3.1.js"></script>
<%--          <script type="text/javascript" src="../js/Js/orders_3.js"></script>--%>
        ...
        $(function () {
            ...
            function daiList_(arry) {
                ...
                for (var i in arry) {
                    ...
                    var l2 = "<td><shiro:hasPermission name='delete'><a class='del' rel='" + arry[i]["id"] + "' href='javascript:;'>删除</a></shiro:hasPermission>";
                    str += l2;
                    str += "&nbsp;&nbsp;&nbsp;<a href='/Shop-SSM/adminfahuoOrdes.do?id=" + arry[i]["id"] + "'>发货</a></td>"
                    str += "</tr>"
                }
                        ...
                        yes: function (index, layero) {
                            $.ajax({
                                ...
                                complete: function (XMLHttpRequest) {
                                    ...
                                    if(redirect === "TIMEOUT"){
                                        window.location.href = "/Shop-SSM/admin/orders_weifa.jsp";
                                    }
                                },
