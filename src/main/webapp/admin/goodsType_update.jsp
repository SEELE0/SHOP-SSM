    ...
    <body>
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">转移商品的类别</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
        ...
        function updates() {
        	if($('#goType').val()==""){
        		...
        		$('#forms').attr("action","/Shop-SSM/adminGoodsBytype.do?id="+GetQueryString("id")+"&goods_type="+$('#goType').val())
        		return true;
        	}
		}
        
        $.ajax({
        	url : "/Shop-SSM/AdminGetType.do",
        	type : "post",
        	data :{
