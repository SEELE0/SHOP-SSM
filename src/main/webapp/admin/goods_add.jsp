...
<head>
    ...
    <body>
                                                ...
                                                <table width="100%"class="cont">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>产品图片：</td>
                                                        <td width="20%"><input type="file" name="imgs" /></td>
                                                        <td>上传产品图片</td>
                                                        <td width="2%">&nbsp;</td>
                                                <tr>
                                                        <td width="2%">&nbsp;</td>
                                                    ...
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td colspan="3"><input class="btn" type="submit" onclick="return submt()" value="提交" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </form>
        ...
        <script>
        $('#forms').attr("action","/Shop-SSM/AdminaddGoods.do")
        function submt() {
        	if($('#goType').val()==""){//判断是否选择了类别
        		alert("请选择分类！")
        		return false;
        	}else{
        ...
        var str=""
            $.ajax({
       	         ...
       	         success : function (m) {
       	        	selectList_(m)
    				$('#goType').append(str)//把类别添加到select中
       	         }
            });
        
        function selectList_(arry) {
			for(var i in arry){
				str+="<option value='"+arry[i]["id"]+"'>"+arry[i]["type_name"]+"</option>"//把类别添加到select中
			}
		}
