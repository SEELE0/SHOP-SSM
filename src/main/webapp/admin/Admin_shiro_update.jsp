...
<head>
    ...
    <body>
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">修改管理员权限</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                            ...
                                            <form id='forms' action="" method="post">
                                                <table width="100%" class="cont">
                                                    <tr>
                                                        <td width="3%">&nbsp;&nbsp;</td>
                                                        <td>原权限：</td>
                                                        <td ><input class="text" id="yuna" type="text" value="" disabled="disabled"/></td>
                                                ...
                                                <tr>
                                                        ...
                                                        <tr>
                                                        <td>&nbsp;</td>
                                                        <td colspan="3"><input class="btn" type="submit" onclick="return updates()"  value="提交" /></td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </form>
        ...
        <script>
        $('#yuna').val(GetQueryString("shiroName"))//原权限
        ...
        function updates() {
        	if($('#goType').val()==""){
        		...
        		$('#forms').attr("action","/Shop-SSM/updateAdminShiro.do/"+$('#goType').val()+"/"+GetQueryString("userId"))
        		return true;
        	}
		}
        ...
        function selectList_(arry) {
			for(var i in arry){
				str+="<option value='"+arry[i]["id"]+"'>"+arry[i]["shiro_name"]+"</option>"
			}
		}
