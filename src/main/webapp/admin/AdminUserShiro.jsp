                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;font-size: 14px">权限管理</h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
          ...
          function AdminList_(arry) {
			...
			for(var i in arry){
				str+="<tr align='center' class='d'>"
					...
					str+="<td style='color:#009688'>"+arry[i]["shiro_name"]+"</td>"
					str+="<td><a href='Admin_shiro_update.jsp?userId="+arry[i]["id"]+"&shiroName="+arry[i]["shiro_name"]+"'>修改权限</a></td>"
					str+="</tr>"
			}
		}
