...
public interface OrdersMapper {
	 ...
	 * @throws Exception
	 */
	int CheckState(Integer id) throws Exception;
	...
	int setStockByID(@Param("id")Integer id,@Param("goods_num")Integer goods_num) throws Exception;

	void delCart(@Param("order_userid")Integer order_userid, @Param("goods_id")Integer goods_id);
}
