...
//	@RequestMapping(value="/get.do",produces="text/html;charset=UTF-8;")
//	@ResponseBody
//	public String goodsget() throws Exception{
//		String goods = typeInetr.goodsget();
//		return goods;
//	}
	...
	public void addType(GoodsType type,HttpServletResponse response) throws Exception{
		...
		if(flag) {
			response.sendRedirect("/Shop-SSM/admin/goods_sort.jsp");
		}else {
			response.setContentType("text/html;charset=utf-8");
			response.getWriter().println("<script>alert('添加失败！');location.href='/Shop-SSM/admin/add_type.jsp';</script>");
		}
	...
	public void AdminUpdateType(GoodsType type,HttpServletResponse response) throws Exception{
		...
		if(flag) {
			...
			response.setContentType("text/html;charset=utf-8");
			response.getWriter().println("<script>alert('修改失败！');location.href='/Shop-SSM/admin/goods_sort.jsp';</script>");
		}
